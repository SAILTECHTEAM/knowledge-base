...
#### Computer Vision (CV)
A comprehensive collection of computer vision learning materials focusing on YOLO (You Only Look Once) object detection algorithms and Convolutional Neural Networks.

**Available Resources:**
- [CNN Notes v2](deep_learning/cv/CNN_Note_v2.pdf) - Convolutional Neural Networks fundamentals and advanced concepts
- [YOLOv1 Notes](deep_learning/cv/YOLOv1_Note_v1.pdf) - Introduction to the first version of YOLO object detection
- [YOLOv2 Notes](deep_learning/cv/YOLOv2_Note_v1.pdf) - YOLO9000: Better, Faster, Stronger
- [YOLOv3 Notes](deep_learning/cv/YOLOv3_Note_v1.pdf) - An Incremental Improvement
- [YOLOv4 Notes](deep_learning/cv/YOLOv4_Notes_v1.pdf) - Optimal Speed and Accuracy of Object Detection
- [YOLOv5 Notes](deep_learning/cv/YOLOv5_Note_v1.pdf) - PyTorch implementation of YOLO
- [YOLOv6 Notes](deep_learning/cv/YOLOv6_Note_v1.pdf) - A single-stage object detection framework
- [YOLOv7 Notes](deep_learning/cv/YOLOv7_Note_v1.pdf) - Trainable bag-of-freebies sets new state-of-the-art
