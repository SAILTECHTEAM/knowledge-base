...
This standalone appendix to the Deconstructing Object Detection series clarifies the measurement system and maps metric values back onto each preceding article's core components. For the series guide, see [architecture and core components](./deconstruction/architecture-overview).
