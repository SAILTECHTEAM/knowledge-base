...
| Appendix | [Evaluation metrics](./evaluation-metrics) | The measurement logic of evaluation protocols: hit rules, PR curves, multi-threshold averaging, size splits, and error attribution. |
